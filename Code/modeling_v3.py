...
img = cv2.imread(r'C:\Users\pilovan\Documents\GitHub\DICOM-ML\Repository\Radiogenomics\CT_InsNum_Sorted_PNG\DCM_InsNum_225.png')
...
labeled_img = cv2.imread(r'C:\Users\pilovan\Documents\GitHub\DICOM-ML\Results\Masks\DCM_InsNum_230_bone_mask.png')
