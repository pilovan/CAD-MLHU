...
for image_test in files[:2]:
    ...
    # cv2.rectangle(segmented_layered, (512,400),(0, 512),(0,0,0), cv2.FILLED)

    # cv2.imshow('image', segmented_layered)
