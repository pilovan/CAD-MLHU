...
image = cv2.imread(r'C:\Users\pilovan\Documents\GitHub\DICOM-ML\Repository\Radiogenomics\CT\000130.jpg')
...
image_labeled = cv2.imread(r'C:\Users\pilovan\Documents\GitHub\DICOM-ML\Results\Segmentation\Bone_segmentation.png')


image_labeled = cv2.cvtColor(image_labeled, cv2.COLOR_BGR2GRAY)
image_labeled1 = image_labeled.reshape(-1)
df['Labeled Image'] = image_labeled1

#print(df.head)

Y = df['Labeled Image'].values
X = df.drop(labels = ['Labeled Image'], axis = 1)
